...
<b>SharpCapDSA</b>: Select one or more objects in AstroPlanner and pressing this button will place that objects SharpCap DSA format onto the clipboard. Paste the entries into SharpCap, using SharpCap’s Deep Sky Annotation dialog.
